...
A reference wiki for Greek mythology, built by reading through primary sources and extracting information systematically. Every claim is cited to a specific passage in a specific ancient text.
...
- [Bibliotheca](sources/apollodorus.md) - Apollodorus (c. 1st-2nd century CE)
- [Fabulae](sources/hyginus.md) - Hyginus (c. 1st century CE)
- [Metamorphoses](sources/metamorphoses.md) - Ovid (c. 8 CE)
- [Aeneid](sources/aeneid.md) - Virgil (c. 19 BCE)
- [Odes](sources/pindar.md) - Pindar (c. 5th century BCE)
...
See [_progress.md](_progress.md) for detailed processing log.
