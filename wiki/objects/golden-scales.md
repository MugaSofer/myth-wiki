...
| | |
|---|---|
| **Also known as** | Golden balances |
| **Owner** | [Zeus](../deities/zeus.md) |
| **First appearance** | [Iliad](../sources/iliad.md) VIII |

## Overview

The **golden scales** are the instrument with which [Zeus](../deities/zeus.md) weighs the fates of mortals. They appear twice in the [Iliad](../sources/iliad.md), each time at a decisive turning point in battle.

## Description

The scales are made of gold, held by their centre, and loaded with "fates of death" — one for each side in the conflict. The side whose fate sinks down is doomed.

### Weighing the Armies (Book VIII)
