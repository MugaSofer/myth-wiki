...
### Theogony
- [x] Lines 1-115: Invocation of the Muses
- [x] Lines 116-153: Cosmogony (Chaos, Gaia, Tartarus, Eros)
- [x] Lines 154-210: Castration of Uranus, birth of Aphrodite
- [x] Lines 211-336: Children of Night, Sea creatures & monsters
- [x] Lines 337-452: Titans and their offspring, Hecate hymn
- [x] Lines 453-506: Birth of Zeus, Cronos swallows children, freeing siblings
- [x] Lines 507-616: Prometheus (trick at Mecone, theft of fire, first woman, punishment)
- [x] Lines 617-735: Titanomachy
- [x] Lines 736-819: Tartarus description (underworld geography)
- [x] Lines 820-880: Typhonomachy
- [x] Lines 881-929t: Zeus's consorts and children, birth of Athena
- [x] Lines 930-1022: Divine marriages, goddesses with mortals, closing
...
**Deities created:**
- zeus.md, gaia.md, uranus.md, cronos.md, rhea.md
- chaos.md, erebus.md, night.md, eros.md, pontus.md
- mnemosyne.md, aphrodite.md, prometheus.md, hecate.md
- athena.md, hera.md, hephaestus.md, ares.md
- apollo.md, artemis.md, hermes.md, dionysus.md
- hades.md, poseidon.md, demeter.md, persephone.md, hestia.md
- iris.md, helius.md, eos.md, selene.md, nereus.md
- atlas.md, styx.md, epimetheus.md, menoetius.md
- muses.md (group), titans.md (group)
- oceanus.md, coeus.md, crius.md, hyperion.md, iapetus.md, theia.md, phoebe.md, tethys.md
- fates.md (group), graces.md (group), horae.md (group)
- themis.md

**Creatures created:**
- cyclopes.md, hundred-handers.md
- gorgons.md, echidna.md, harpies.md, giants.md, erinyes.md
- typhoeus.md
- cerberus.md, chimaera.md, sphinx.md, pegasus.md, nemean-lion.md, hydra.md

**Heroes created:**
- heracles.md, perseus.md

**Places created:**
- olympus.md, helicon.md, tartarus.md
...
### Homeric Hymns — Full Pass

**Source page created:** homeric-hymns.md

**Major Hymns processed:**
- Hymn I (to Dionysus): Variant birth traditions
- Hymn II (to Demeter): Abduction of Persephone, Demeter's search, Demophoon, the famine, the pomegranate, Eleusinian Mysteries
- Hymn III (to Apollo): Birth on Delos, first words, dragon at Pytho, founding of Delphic oracle, Cretan priests, Hera's speech (Typhaon variant, casting out Hephaestus)
- Hymn IV (to Hermes): Birth, invention of the lyre, cattle theft, trial before Zeus, exchange with Apollo, domains assigned
- Hymn V (to Aphrodite): Three immune goddesses, seduction of Anchises, birth of Aeneas, Eos and Tithonus, Hestia's oath

**Shorter Hymns processed:**
- Hymn VII (to Dionysus): Pirates, miracles, dolphin transformation
- Hymn XIX (to Pan): Birth, description, pipes
- Hymn XXVII (to Artemis): The huntress, dances at Delphi
- Hymn XXVIII (to Athena): Cosmic reaction to birth
- Hymn XXXI (to Helios): Mother named Euryphaessa (variant for Theia)
- Hymn XXXII (to Selene): Daughter Pandia by Zeus

**Pages updated:** demeter.md, persephone.md, hades.md, hecate.md, helius.md, hermes.md, iris.md, dionysus.md, apollo.md, hera.md, hephaestus.md, aphrodite.md, hestia.md, eos.md, athena.md, artemis.md, selene.md

**New page created:** pan.md

### Works and Days — Full Pass

**Source page created:** works-and-days.md

**Mythological sections processed:**
- Lines 1-10: Invocation to Zeus
- Lines 11-26: The Two Strifes (variant tradition — two, not one)
- Lines 42-105: Prometheus retelling, Pandora named, the jar
- Lines 106-201: Five Ages of Man (Gold, Silver, Bronze, Heroic, Iron)
- Lines 202-285: Fable of hawk and nightingale; Justice (Dike) personified

**Remaining sections (practical/agricultural):**
- Lines 286-828: Moral exhortations, farmer's calendar, seafaring, social conduct, lucky/unlucky days — minimal mythological content (incidental divine references only)

**Pages updated:** prometheus.md (Pandora retelling, Zeus's speech, the jar), cronos.md (Golden Age, released from bonds, Islands of the Blessed), night.md (Two Strifes variant), horae.md (Dike personified, Hymn VI role), epimetheus.md (link fix)

**New pages created:** five-ages.md (event), works-and-days.md (source)
